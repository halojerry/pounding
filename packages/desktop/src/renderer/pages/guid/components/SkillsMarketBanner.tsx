...
const SKILLS_MARKET_DETAILS_ZH = 'https://github.com/halojerry/pounding/discussions/1326';
const SKILLS_MARKET_DETAILS_EN = 'https://github.com/halojerry/pounding/discussions/1325';
