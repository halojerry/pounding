...
var __electron_vite_injected_dirname = '/Users/halo/Documents/pounding desktop/AionUi/packages/desktop';
              ...
              (() => {
                ...
                return {
                  ...
                  buildStart: async (opt) => {
                    try {
                      await sentryPlugin.buildStart?.(opt);
                    } catch (e) {
                      console.warn('[sentry] Build integration failed (non-fatal):', e.message);
                    }
                  },
                  writeBundle: async (opt, bundle) => {
                    try {
                      await sentryPlugin.writeBundle?.(opt, bundle);
                    } catch (e) {
                      console.warn('[sentry] Build integration failed (non-fatal):', e.message);
                    }
                  },
