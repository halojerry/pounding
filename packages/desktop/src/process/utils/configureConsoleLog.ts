 ...
 *   - macOS:   ~/Library/Logs/POUNDING/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\POUNDING\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/POUNDING/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
