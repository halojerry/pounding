...
for f in POUNDING-1.0.0-win-x64.exe POUNDING-1.0.0-win-arm64.exe POUNDING-1.0.0-mac-x64.dmg POUNDING-1.0.0-mac-arm64.dmg POUNDING-1.0.0.deb POUNDING-1.0.0-arm64.deb; do
  if [ ! -f "$OUTPUT_DIR/$f" ]; then
...
for plat in darwin-arm64 darwin-x86_64 linux-arm64 linux-x86_64 win-x86_64; do
  tarball="pounding-web-1.0.0-${plat}.tar.gz"
