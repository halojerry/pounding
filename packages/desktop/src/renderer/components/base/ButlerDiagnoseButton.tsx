 ...
 * POUNDING Butler selected and a diagnosis prompt (including the error text)
  ...
  const handleClick = useCallback(
    (event: React.MouseEvent<HTMLElement>) => {
      ...
      const prompt = t('settings.talkToButler.prompt.diagnoseChatError', {
        defaultValue:
          'I ran into an error during a conversation in POUNDING, please help me diagnose it.\n\n[Error] {{error}}\n\nPlease diagnose the cause and tell me how to fix it.',
