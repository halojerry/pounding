...
MIRROR="${MIRROR:-https://github.com/halojerry/pounding/releases/download}"
...
download_tarball() {
    ...
    # Build download URL
    # MIRROR formats:
    #   - GitHub: https://github.com/halojerry/pounding/releases/download
...
print_summary() {
    ...
    echo ""
    echo -e "  ${BOLD}📖 Documentation:${NC}  https://github.com/halojerry/pounding"
