...
## [0.1.51](https://github.com/halojerry/pounding/compare/v0.1.50...v0.1.51) (2026-07-22)


### Features

* **acp,conversation:** elevate ACP protocol + assistant lineage logs to info ([#318](https://github.com/halojerry/pounding/issues/318)) ([fbcb299](https://github.com/halojerry/pounding/commit/fbcb29962da5ca4f52516663d592b57815875873))
* **acp:** backport config-options endpoint with POUNDING ActiveAgentNotFound handling ([1ee1378](https://github.com/halojerry/pounding/commit/1ee1378d54f15d3dca6ed00a078da8a16d65f6b6))
* **acp:** dead ACP connection recovery — phase tracking + guards + eviction ([887c225](https://github.com/halojerry/pounding/commit/887c225125a18759040b4ce245f142a7bc6cc945))
* **acp:** inject OPENCODE_CONFIG for OpenCode, OPENCLAW env vars for OpenClaw ([4d88d26](https://github.com/halojerry/pounding/commit/4d88d26d86a593b13a9f7e12291fd0d9d5a31406))
* **acp:** use observed config options for preferences ([#468](https://github.com/halojerry/pounding/issues/468)) ([fd2d5c2](https://github.com/halojerry/pounding/commit/fd2d5c2db10e80dc478ee88c2d1f787e91015eb1))
* add 3 new builtin assistants (teacher, getnote, xiaohongshu-creator) ([28e535a](https://github.com/halojerry/pounding/commit/28e535a2517c79c8c29fc8c94d9e4d968ee26312))
* add GET/PUT /api/settings/managed-runtime endpoint ([9e5d1a4](https://github.com/halojerry/pounding/commit/9e5d1a45b9e4ce6e395537f35d1decb19a8fc3cb))
* add is_full_url flag for provider URL resolution ([#307](https://github.com/halojerry/pounding/issues/307)) ([3aa15da](https://github.com/halojerry/pounding/commit/3aa15da0c70a15da097e5bd839b83c4c0c720bf1))
* add pounding serde alias for ConversationSource ([9a41a59](https://github.com/halojerry/pounding/commit/9a41a591395cd794500d189c0ea4ca5e57dbcdcf))
* **agent:** classify structured agent send errors ([#356](https://github.com/halojerry/pounding/issues/356)) ([f52e8cd](https://github.com/halojerry/pounding/commit/f52e8cd93edb3e5edbee450ca41bef49e4cc9c48))
* **agent:** detect availability via session/new probe and assistant-first identity ([#500](https://github.com/halojerry/pounding/issues/500)) ([6c9a721](https://github.com/halojerry/pounding/commit/6c9a721fc4cf2b712f5c7b974f51b2935a0293b7))
* **agents:** add Pi coding agent as builtin ACP agent ([#618](https://github.com/halojerry/pounding/issues/618)) ([0b9b3a8](https://github.com/halojerry/pounding/commit/0b9b3a882712f555e60fd33c027b604471df25c7))
* **agents:** sync ACP Registry integrations ([#637](https://github.com/halojerry/pounding/issues/637)) ([7d35e38](https://github.com/halojerry/pounding/commit/7d35e386969bb2dca58ca332adf00f9ae5bed6ce))
* **agent:** use aionrs runtime env API ([#586](https://github.com/halojerry/pounding/issues/586)) ([2f6f43f](https://github.com/halojerry/pounding/commit/2f6f43f305221701ca2baa58123180caf2342055))
* **ai-agent:** adapt to aionrs v0.2.2 config changes ([4f71bf2](https://github.com/halojerry/pounding/commit/4f71bf2c97de1bafc676906e26a5cf512ff94af9))
* **ai-agent:** add cc-switch provider env injection for Claude ACP ([#291](https://github.com/halojerry/pounding/issues/291)) ([a7b93e7](https://github.com/halojerry/pounding/commit/a7b93e7dde78a7b254e26e2d2e25d7b9b885ad5b))
* **ai-agent:** log every CLI detection + add doctor subcommand ([#285](https://github.com/halojerry/pounding/issues/285)) ([5ef6d0a](https://github.com/halojerry/pounding/commit/5ef6d0a4d99345a502a9073dfdfa0d07cfa52a8c))
* **ai-agent:** route image attachments by model capability ([82c5bc1](https://github.com/halojerry/pounding/commit/82c5bc14bcb1fcf4396e033764732adbe63966ef))
* **ai-agent:** surface upstream 429 body in AgentSendError detail ([#591](https://github.com/halojerry/pounding/issues/591)) ([b8fe5b6](https://github.com/halojerry/pounding/commit/b8fe5b6f3c6f93f7b8fc730b658772da3f4f83fa))
* **ai-agent:** use responses api for gpt-5.6 ([cde4129](https://github.com/halojerry/pounding/commit/cde4129521340fe71e67a40f17f0d00a2935fe2a))
* **ai-agent:** use responses api for gpt-5.6 ([15bbb1e](https://github.com/halojerry/pounding/commit/15bbb1eeb97fa619bea14733958fc9623100a274))
* **aioncore:** add ozon builtin assistant and skill bundle ([a5d2c19](https://github.com/halojerry/pounding/commit/a5d2c1946e419c19169c3bf704905bdf8f41ebef))
* **aionrs:** consume attached files as structured content blocks ([0f8c7d1](https://github.com/halojerry/pounding/commit/0f8c7d1b681d35fdf55b857948978fc28444bf61))
* **aionrs:** expose slash commands API ([c9d30ca](https://github.com/halojerry/pounding/commit/c9d30ca63b7840fd997048bb4ffbe1b4976eb63c))
* **aionrs:** inline image attachments for Aion CLI ([aff870b](https://github.com/halojerry/pounding/commit/aff870bb1d3328abfc3d0c24d8898f0e148790ab))
* **aionrs:** inline image attachments for Aion CLI ([e4e5e9b](https://github.com/halojerry/pounding/commit/e4e5e9b26867b59f8c66a11b1fc80abc0029b651))
* align team shared workspace resolution ([#475](https://github.com/halojerry/pounding/issues/475)) ([06b8e71](https://github.com/halojerry/pounding/commit/06b8e71572045ddac640bda38e2733dd9ad35f18))
* **assets:** update Kimi logo to official brand mark ([#646](https://github.com/halojerry/pounding/issues/646)) ([1c41b50](https://github.com/halojerry/pounding/commit/1c41b50d93b5cdb188792d9c6e794fb0e0a950a0))
* **assistant:** add built-in AionUi self-management assistant ([#474](https://github.com/halojerry/pounding/issues/474)) ([eea941e](https://github.com/halojerry/pounding/commit/eea941e344b9dd11338393078c63bddcc532137e))
* **assistant:** expand AionUi assistant into a butler with remote-access ([#481](https://github.com/halojerry/pounding/issues/481)) ([794c21a](https://github.com/halojerry/pounding/commit/794c21a589ef24de6f3fa03a628bb47e7958d6fe))
* **assistant:** persist thought-level defaults ([#574](https://github.com/halojerry/pounding/issues/574)) ([dd9f299](https://github.com/halojerry/pounding/commit/dd9f29967270f4e7263484532fad3b2199ba1894))
* **assistant:** 官方助手默认关闭 + 固定顺序 + 一次性重置迁移 ([#567](https://github.com/halojerry/pounding/issues/567)) ([3e30b02](https://github.com/halojerry/pounding/commit/3e30b02e021642ea116b68abc441bca0b91c60f3))
* **auth:** add NewApi login endpoint for WebUI ([e4aa3d7](https://github.com/halojerry/pounding/commit/e4aa3d7dc933441bfdb6578d3bf265623d10d9fa))
* bundle managed node and ACP runtime resources ([#403](https://github.com/halojerry/pounding/issues/403)) ([6aafd57](https://github.com/halojerry/pounding/commit/6aafd572178ff4197b7a356db48fea8250d50318))
* cc-switch unified 5-CLI config + model switch fix + ozon skill updates ([2739f94](https://github.com/halojerry/pounding/commit/2739f948cba8802f25445422e02a473b8234c658))
* **ci:** bundle managed CLI resources (node,acp,native) in release ([dddc8f8](https://github.com/halojerry/pounding/commit/dddc8f8a12cc1a33304f7aed5b3f2f744af946b5))
* **cli:** add agent-facing config and diagnose commands ([#595](https://github.com/halojerry/pounding/issues/595)) ([e80177e](https://github.com/halojerry/pounding/commit/e80177e95a380c89f833b4302ff24b7359ac2a58))
* **cli:** canonicalize CLI and bootstrap boundary errors ([#417](https://github.com/halojerry/pounding/issues/417)) ([9ddf82e](https://github.com/halojerry/pounding/commit/9ddf82e374f9f40fa5f7321fea54dca3a611f3c5))
* **config:** add conversation rename command ([#638](https://github.com/halojerry/pounding/issues/638)) ([a611553](https://github.com/halojerry/pounding/commit/a61155379ac031a161b210d4bdc297d009ba5a11))
* converge team mode runtime architecture ([#464](https://github.com/halojerry/pounding/issues/464)) ([abeb9a1](https://github.com/halojerry/pounding/commit/abeb9a184a280a8da1f9089a90f7be2db3c94af4))
* **conversation:** add cursor pagination for messages ([#515](https://github.com/halojerry/pounding/issues/515)) ([ba76273](https://github.com/halojerry/pounding/commit/ba7627328ae8447afb7566e90cbb556fa381dff0))
* **cron:** deduplicate and protect scheduled executions ([#601](https://github.com/halojerry/pounding/issues/601)) ([b189de0](https://github.com/halojerry/pounding/commit/b189de0e0a5a3cb837de8b0237ce6e7f96c8aa3d))
* **diagnostics:** expand feedback runtime evidence ([#612](https://github.com/halojerry/pounding/issues/612)) ([08426dc](https://github.com/halojerry/pounding/commit/08426dcf83290577a2b8ef706bc3c1d21354425c))
* enforce agent runtime policy and turn-aware state ([#436](https://github.com/halojerry/pounding/issues/436)) ([b7099fe](https://github.com/halojerry/pounding/commit/b7099fee0cd2488326957dfe7811bf87e15aabb7))
* enforce TeamRun ownership for agent turns ([#483](https://github.com/halojerry/pounding/issues/483)) ([4cc168a](https://github.com/halojerry/pounding/commit/4cc168a57c07879310d9e4fe8b8050735f35155a))
* **idle:** extend idle-cleanup timeouts and make them env-configurable ([#643](https://github.com/halojerry/pounding/issues/643)) ([a719bc7](https://github.com/halojerry/pounding/commit/a719bc74a5587097246689c683079488fba73007))
* integrate 45 builtin assistants + 170 skills + 47 avatars + 156 rules ([7072069](https://github.com/halojerry/pounding/commit/7072069bf86a6616e3dc5eb4b15e811420724be9))
* **lark:** add Lark/Feishu builtin assistant with 27 skills ([a47a2a4](https://github.com/halojerry/pounding/commit/a47a2a452fc426f6b302b483382ce4c164061f7c))
* **mcp:** add Chrome DevTools as builtin MCP server for all agents ([e9462c1](https://github.com/halojerry/pounding/commit/e9462c122828ad8dfc7b3bc6401cab808137c1e4))
* **mcp:** support session scoped MCP injection ([#363](https://github.com/halojerry/pounding/issues/363)) ([2974f47](https://github.com/halojerry/pounding/commit/2974f47346056ef5483fe3e9c39d58d63f714ae7))
* **mcp:** wire Image Generation MCP into ACP sessions ([dff9c2a](https://github.com/halojerry/pounding/commit/dff9c2a2cd7d622014d35ec66691f834d03db65e))
* **ozon:** bump skill to v0.7.0 — add search, probe, fix-prices commands ([a3df382](https://github.com/halojerry/pounding/commit/a3df382e1268fdd773b84fc1b928482cf3972b2c))
* **provider:** add per-model capability settings ([0f60d7e](https://github.com/halojerry/pounding/commit/0f60d7edda96f3a3a43d27765a8e800f53c6d294))
* **provider:** add per-model capability settings ([ba3e9ff](https://github.com/halojerry/pounding/commit/ba3e9ff1a893bf7111173b8e9301a0c2f140a2c1))
* register pounding-expert and social-cover-design builtin assistants ([c17bc8e](https://github.com/halojerry/pounding/commit/c17bc8e784c1dd37bc4e0efc3d8b9d1638535ea6))
* remove single-chat team upgrade path ([#524](https://github.com/halojerry/pounding/issues/524)) ([5c60df3](https://github.com/halojerry/pounding/commit/5c60df38473b5a566e4f3598f6a36dfb63f52bab))
* **runtime:** full shell-style command in spawn logs ([#278](https://github.com/halojerry/pounding/issues/278)) ([dd51616](https://github.com/halojerry/pounding/commit/dd516165ae9e22fcb0573ae9d8d3aa094e54cff2))
* **stt:** streaming transcription proxy over websocket ([#455](https://github.com/halojerry/pounding/issues/455)) ([1c19a8b](https://github.com/halojerry/pounding/commit/1c19a8b9a80be665d30310071c0c12bc95881c11))
* **system:** add feedback diagnostics report ([#585](https://github.com/halojerry/pounding/issues/585)) ([a3eb1e4](https://github.com/halojerry/pounding/commit/a3eb1e49396e715ce8464700dca5e50a966552ee))
* **team:** add CLI fallback collaboration transport ([#629](https://github.com/halojerry/pounding/issues/629)) ([bbb6fec](https://github.com/halojerry/pounding/commit/bbb6fec08f7fd818375664bc5bf206805013f7d0))
* **team:** add run state snapshot endpoint ([#549](https://github.com/halojerry/pounding/issues/549)) ([2c7cfe8](https://github.com/halojerry/pounding/commit/2c7cfe8a3eb49c8be790a7733ccad2f8a49f19bd))
* **team:** centralize team MCP prompt governance ([#490](https://github.com/halojerry/pounding/issues/490)) ([5485a95](https://github.com/halojerry/pounding/commit/5485a95897c327dc2c8f4f1c44cfab7c6f628905))
* **team:** support queued team_send_message semantics ([#479](https://github.com/halojerry/pounding/issues/479)) ([a57a079](https://github.com/halojerry/pounding/commit/a57a079136cbe8a5fafa0ff4d8660bbfa28a07c5))
* **team:** support slot-scoped team pause and wake flow ([#472](https://github.com/halojerry/pounding/issues/472)) ([398b20f](https://github.com/halojerry/pounding/commit/398b20f2279fc7b042ae65cbbe5658be953e6f31))


### Bug Fixes

* **A1:** return actual config_options from session aggregate on mode/model switch ([c979d46](https://github.com/halojerry/pounding/commit/c979d464eccd2b8ca536c960635115e161a9cc1f))
* **A2:** pass image-gen MCP script path as args to node ([32dac59](https://github.com/halojerry/pounding/commit/32dac596c594a332e17a786a3a3a0e9d450483e2))
* **A3:** generate manifest.json for bundled CLI resources ([7f7d2d6](https://github.com/halojerry/pounding/commit/7f7d2d6385f17b365dd62b797de3431485a533f9))
* **A9:** load DB builtin MCP servers when enabled ([06d37db](https://github.com/halojerry/pounding/commit/06d37db46ea363c690e7ffec8037f6546b492fc5))
* AC-1 + AC-2 — shutdown grace period + non-fatal persistence ([114b384](https://github.com/halojerry/pounding/commit/114b3843925e6941d9a29901288d7db21d0b9dd7))
* **acp:** add warning logs when OpenClaw config/token cannot be read ([f947996](https://github.com/halojerry/pounding/commit/f947996c0df7f5ce2e5c70d36ecfffeee191923f))
* **acp:** apply AvailableCommands event to session aggregate ([#270](https://github.com/halojerry/pounding/issues/270)) ([a46b561](https://github.com/halojerry/pounding/commit/a46b561b20421a59fd73e9629ef452c624781ef2))
* **acp:** bound config RPC timeout and release lease without tearing down connection ([#654](https://github.com/halojerry/pounding/issues/654)) ([c9a0051](https://github.com/halojerry/pounding/commit/c9a005163df4dfef48bdbdd01f67be04cae120dd))
* **acp:** config_not_observed fix + MCP diagnostics + cargo fmt ([#19](https://github.com/halojerry/pounding/issues/19)) ([76ada73](https://github.com/halojerry/pounding/commit/76ada73421486a02b0d42bbcb93537c11d69cd07))
* **acp:** confirm legacy mode/model on ACK instead of awaiting observed update ([#635](https://github.com/halojerry/pounding/issues/635)) ([ded7a5c](https://github.com/halojerry/pounding/commit/ded7a5ce7951cad942852488f30382ed7fb909da))
* **acp:** harden grok startup environment and npx recovery ([#662](https://github.com/halojerry/pounding/issues/662)) ([10cdd57](https://github.com/halojerry/pounding/commit/10cdd579849e6430c360cc88b25896ff8c146490))
* **acp:** load user MCP servers and emit empty-finish diagnostic (ELECTRON-1JG) ([#327](https://github.com/halojerry/pounding/issues/327)) ([2a6c2e9](https://github.com/halojerry/pounding/commit/2a6c2e943683a72eebaaa1d608be10fe5f795634))
* **acp:** normalize Codex full-access mode ([#608](https://github.com/halojerry/pounding/issues/608)) ([df51fcf](https://github.com/halojerry/pounding/commit/df51fcf77aa541c78c6eb6af4e987eab92b1ff07))
* **acp:** persist runtime model and mode into assistant preferences ([#482](https://github.com/halojerry/pounding/issues/482)) ([b9bcad9](https://github.com/halojerry/pounding/commit/b9bcad9d2deb94281a084c4b43a9f09c477444ed))
* **acp:** prefer config options catalogs ([#425](https://github.com/halojerry/pounding/issues/425)) ([9d89cc9](https://github.com/halojerry/pounding/commit/9d89cc9b46cc684a04c2cb9452ed9d792bd3a8de))
* **acp:** preserve confirmed model selection ([#437](https://github.com/halojerry/pounding/issues/437)) ([e16e11f](https://github.com/halojerry/pounding/commit/e16e11fa1e6ff9bd6449a8b1bc6bcfb5859fc865))
* **acp:** preserve selectors for partial config snapshots ([#548](https://github.com/halojerry/pounding/issues/548)) ([0cb3a9a](https://github.com/halojerry/pounding/commit/0cb3a9a5925b273ec1b6610c04469f8724ad14fb))
* **acp:** recover dead ACP connections ([#487](https://github.com/halojerry/pounding/issues/487)) ([8264873](https://github.com/halojerry/pounding/commit/8264873c3879a199201d3700a9f7a9a7b7ba1534))
* **acp:** redirect config-options model/mode to working endpoints ([67e918c](https://github.com/halojerry/pounding/commit/67e918cd0a8767cf00315d6a446b8500681cd779))
* **acp:** stabilize mode and model source of truth ([#409](https://github.com/halojerry/pounding/issues/409)) ([300bb1e](https://github.com/halojerry/pounding/commit/300bb1eba0c30207918dc9b23a2934f3542d2fe4))
* **acp:** track close reason to avoid reporting user cancel as crash (ELECTRON-1K0) ([#328](https://github.com/halojerry/pounding/issues/328)) ([9506f9d](https://github.com/halojerry/pounding/commit/9506f9d1666e26b8659e3339dbfa8f13568f54ce))
* add pounding-heart-solid.png to backend asset bundle ([8ca97a2](https://github.com/halojerry/pounding/commit/8ca97a2cf71d881c4d64ce5bea6ae81b702d3dd7))
* **agent:** adapt aionrs compat API ([#528](https://github.com/halojerry/pounding/issues/528)) ([f4ad432](https://github.com/halojerry/pounding/commit/f4ad4326342c7c93abaa1da121683d472028c2f5))
* **agent:** add provider health check probe ([#358](https://github.com/halojerry/pounding/issues/358)) ([d3a8702](https://github.com/halojerry/pounding/commit/d3a8702c2c98a78085a24860bb20a15b1682dfda))
* **agent:** align unchecked availability with team runtime selection ([#571](https://github.com/halojerry/pounding/issues/571)) ([f80b0ce](https://github.com/halojerry/pounding/commit/f80b0ceac3b603c3b58e0f1a25feb31a0261f7c8))
* **agent:** avoid full availability refresh on reads ([#566](https://github.com/halojerry/pounding/issues/566)) ([1ffb7aa](https://github.com/halojerry/pounding/commit/1ffb7aa6a0fcb55a4c8966b965133ab0ace9e8b2))
* **agent:** classify ACP and provider errors ([#518](https://github.com/halojerry/pounding/issues/518)) ([ef573d0](https://github.com/halojerry/pounding/commit/ef573d0071acc0c9f4671da8a4029abea8ec2a57))
* **agent:** classify Bedrock 'model identifier is invalid' as model-not-found (AIO-12) ([#377](https://github.com/halojerry/pounding/issues/377)) ([07dc3ac](https://github.com/halojerry/pounding/commit/07dc3ac8b2fae8962e8a7e31a223875669e11ba1))
* **agent:** expose aionrs mode config option ([#501](https://github.com/halojerry/pounding/issues/501)) ([d1a360d](https://github.com/halojerry/pounding/commit/d1a360de17114dad5e1834ab2fc8531672ffd17b))
* **agent:** expose runtime catalogs from metadata ([#523](https://github.com/halojerry/pounding/issues/523)) ([d9c2502](https://github.com/halojerry/pounding/commit/d9c2502e499a6794476fcdbe63a14573b4fa81d0))
* **agent:** guard internal Aion CLI command overrides ([#538](https://github.com/halojerry/pounding/issues/538)) ([f141233](https://github.com/halojerry/pounding/commit/f141233b0cbe03a8f8ae61372d2a8fdabb9cb81c))
* **agent:** make codex sandbox sync non-fatal ([#370](https://github.com/halojerry/pounding/issues/370)) ([8916faa](https://github.com/halojerry/pounding/commit/8916faa9bc69ff1959aef2db83febb7c03f1441b))
* **agent:** preserve ACP error cause detail ([#581](https://github.com/halojerry/pounding/issues/581)) ([220f682](https://github.com/halojerry/pounding/commit/220f6823c1d29fde640427cfdd77de7e981758b2))
* **agent:** preserve process-group cleanup after leader exit ([#369](https://github.com/halojerry/pounding/issues/369)) ([73d4fb4](https://github.com/halojerry/pounding/commit/73d4fb4f4e4647352ba3dcac07e4a6b277e46c7b))
* **agent:** project available commands in management rows ([#579](https://github.com/halojerry/pounding/issues/579)) ([689ee8f](https://github.com/halojerry/pounding/commit/689ee8f91cbabd7e57c4e882f86c1ceec167e36d))
* **agent:** reflect auth failures from real turns into agent availability ([#655](https://github.com/halojerry/pounding/issues/655)) ([769eecb](https://github.com/halojerry/pounding/commit/769eecb761b3c5ee3f5cb055e972168aeea014d5))
* **agent:** reject and clear launch-path override for npx-bridged agents ([#651](https://github.com/halojerry/pounding/issues/651)) ([0724757](https://github.com/halojerry/pounding/commit/07247577c3be21b7e0aa39ead24e3afddbd13c2e))
* **agent:** send non-empty clientInfo in ACP initialize handshake ([#471](https://github.com/halojerry/pounding/issues/471)) ([7ea1f8e](https://github.com/halojerry/pounding/commit/7ea1f8ef28c0e22d147fcc471b3c8f5a2ac905d3))
* **agent:** send non-empty clientInfo in ACP initialize handshake ([#471](https://github.com/halojerry/pounding/issues/471)) ([5a8df22](https://github.com/halojerry/pounding/commit/5a8df22fd9db4b77ec0c7e9870aec78db6d7bec7))
* **agents:** honor login PATH and validate builtin CLIs ([#622](https://github.com/halojerry/pounding/issues/622)) ([3190be1](https://github.com/halojerry/pounding/commit/3190be1fae7e15be98f5f963e57a54fdee87029e))
* **agent:** support aionrs 0.1.31 ([#503](https://github.com/halojerry/pounding/issues/503)) ([d612602](https://github.com/halojerry/pounding/commit/d612602aa3bfa88bef60a85a1aa5cb40634055fd))
* **agent:** surface OpenClaw Gateway unreachable errors ([#498](https://github.com/halojerry/pounding/issues/498)) ([90d34ae](https://github.com/halojerry/pounding/commit/90d34aee81d484c949b3fc4358447095752e2b8d))
* **agent:** surface sign-in hint on empty ACP turns from auth-gated agents ([#653](https://github.com/halojerry/pounding/issues/653)) ([7a8c26e](https://github.com/halojerry/pounding/commit/7a8c26e31509a3794e272596e0c100168de65c7b))
* **agent:** tighten send_error classifier (AIO-87, AIO-89, AIO-90) ([#375](https://github.com/halojerry/pounding/issues/375)) ([d9a2f76](https://github.com/halojerry/pounding/commit/d9a2f763d14ec642c09f3aef5a2d8b716f4b0648))
* **agent:** validate managed ACP platform binaries ([#462](https://github.com/halojerry/pounding/issues/462)) ([651c79f](https://github.com/halojerry/pounding/commit/651c79f0ec0e07009f637ebb2afa14de47c95ba3))
* **agent:** wait for task shutdown during clear ([#446](https://github.com/halojerry/pounding/issues/446)) ([bea814e](https://github.com/halojerry/pounding/commit/bea814e08ddb96ccb5d09a8016e92d179a2f318a))
* **ai-agent:** auto approve team mcp permissions ([#447](https://github.com/halojerry/pounding/issues/447)) ([096953e](https://github.com/halojerry/pounding/commit/096953e038aaa1f07333bbd6751ee927bf129e60))
* **ai-agent:** cap provider health check tokens ([1021b63](https://github.com/halojerry/pounding/commit/1021b631aa1b7b97d7b70d18284df21bf29dda41))
* **ai-agent:** enable official kimi k2.7 code image input ([c4b2795](https://github.com/halojerry/pounding/commit/c4b279583a0bf1d127d867a1d403a1f195bbed91))
* **ai-agent:** enable official kimi k2.7 code image input ([4bff331](https://github.com/halojerry/pounding/commit/4bff3311231e9b526a5ad27ddc74b200a8b83b3d))
* **ai-agent:** force-kill ACP processes on Windows (ELECTRON-1E9) ([#303](https://github.com/halojerry/pounding/issues/303)) ([e60fdd3](https://github.com/halojerry/pounding/commit/e60fdd31332512398715ed056a7f60eeee42a752))
* **ai-agent:** ignore max token limits for aionui requests ([0121c24](https://github.com/halojerry/pounding/commit/0121c24d70f4a5a63e79ee71869aee34e6b62506))
* **ai-agent:** ignore max token limits for aionui requests ([8bdf305](https://github.com/halojerry/pounding/commit/8bdf305e9a94d1a5aa8402424e8ef8d540eeb66c))
* **ai-agent:** make find_native_claude cross-platform (ELECTRON-1CG) ([#299](https://github.com/halojerry/pounding/issues/299)) ([fda9239](https://github.com/halojerry/pounding/commit/fda92398caa9384d8f0cdc11cf0a3616047448af))
* **ai-agent:** negotiate OpenClaw protocol v3..v4 ([#288](https://github.com/halojerry/pounding/issues/288)) ([dfeece0](https://github.com/halojerry/pounding/commit/dfeece0e6a465093090c0efdfa1f5aa93d9fa6e8))
* **ai-agent:** pin image-capable aionrs revision ([6687805](https://github.com/halojerry/pounding/commit/6687805f09042b9a34b4e5ac22900374358d2671))
* **ai-agent:** prevent stuck session after ACP cancel ([#313](https://github.com/halojerry/pounding/issues/313)) ([3a84bfe](https://github.com/halojerry/pounding/commit/3a84bfec1bfffd589d091efdd7b157ea1c3b2960))
* **ai-agent:** rebuild ACP session when CLI rejects stale sid (ELECTRON-1HQ) ([#320](https://github.com/halojerry/pounding/issues/320)) ([b4d8a75](https://github.com/halojerry/pounding/commit/b4d8a7505e78c48ed26af364b6e13ad4302b4727))
* **ai-agent:** return 409 when remote WS not connected on cancel (ELECTRON-1CV) ([#302](https://github.com/halojerry/pounding/issues/302)) ([dc87f1c](https://github.com/halojerry/pounding/commit/dc87f1c37352be6cd820503ed4c38be4098d26ed))
* **ai-agent:** set default aionrs thinking cli args ([de240a4](https://github.com/halojerry/pounding/commit/de240a4435058bf349acd7897b2836cff49b884d))
* **ai-agent:** surface ACP startup crashes and accept work_dir paths (ELECTRON-1BT) ([#305](https://github.com/halojerry/pounding/issues/305)) ([7aa29a7](https://github.com/halojerry/pounding/commit/7aa29a78a2fa5013b9a4845217ba89d4b045822b))
* **ai-agent:** trim stderr buffer at UTF-8 char boundary ([#443](https://github.com/halojerry/pounding/issues/443)) ([7380c7c](https://github.com/halojerry/pounding/commit/7380c7cdd3c08a51de397e6af32f22361199b592))
* AIONCORE_LISTENING → POUNDINGCORE_LISTENING ([41a2922](https://github.com/halojerry/pounding/commit/41a292284662510193f68de708ac7a7d11e22c10))
* **aioncore:** align aionrs identity and cc-switch sync ([6c8731b](https://github.com/halojerry/pounding/commit/6c8731b35c086ecf13dc4302de5d650371d8b63b))
* **aioncore:** resolve binary rename, migration 007, and merge conflict artifacts ([d8e421d](https://github.com/halojerry/pounding/commit/d8e421d66d62ac1c9c929cc64dcb3a9951299c96))
* **aionrs:** adapt runtime guard config ([#510](https://github.com/halojerry/pounding/issues/510)) ([464f453](https://github.com/halojerry/pounding/commit/464f4533822c8959a4d0f4d4d81d2b998152498e))
* **aionrs:** classify engine errors structurally ([#494](https://github.com/halojerry/pounding/issues/494)) ([8552b0a](https://github.com/halojerry/pounding/commit/8552b0a30f0eb323d62032986919170c05374c6a))
* **aionrs:** default missing model protocol to openai ([be519dc](https://github.com/halojerry/pounding/commit/be519dcc73af8e274c8d6d7e06fa103cdd115eae))
* **aionrs:** drop malformed tool-call events ([#486](https://github.com/halojerry/pounding/issues/486)) ([67ffbd0](https://github.com/halojerry/pounding/commit/67ffbd03d3aa17a46b47d6eafe08277edaaacdc4))
* **aionrs:** drop orphaned tool_call history on session resume (ELECTRON-1HV, ELECTRON-1J6) ([#330](https://github.com/halojerry/pounding/issues/330)) ([880722f](https://github.com/halojerry/pounding/commit/880722fd3b2f4e37fa5654cc5ed210cddbfd14b5))
* **aionrs:** preserve tool call correlation across aborts ([#335](https://github.com/halojerry/pounding/issues/335)) ([d65c8ed](https://github.com/halojerry/pounding/commit/d65c8ed49be4a558aff99e907e359264d6729d1c))
* **aionrs:** respect model protocol over base url ([10f3ce9](https://github.com/halojerry/pounding/commit/10f3ce97b569894d6e29edab9c661b9869198ef4))
* **aionrs:** stop inferring anthropic v1 suffix ([ed8f26c](https://github.com/halojerry/pounding/commit/ed8f26c6a1e9474984602712349e0ad2961108c4))
* **aionrs:** use versioned anthropic path for custom providers ([e300395](https://github.com/halojerry/pounding/commit/e30039568edda6619dbf8da99c56d23157ca031c))
* **aionui-ai-agent:** classify aionrs API connection errors ([#389](https://github.com/halojerry/pounding/issues/389)) ([c3f16f7](https://github.com/halojerry/pounding/commit/c3f16f7453d061d0865cb7c61eca183a6d6e797f))
* **aionui-ai-agent:** strip HTML body from sanitized error detail (AIO-13) ([#380](https://github.com/halojerry/pounding/issues/380)) ([9fc5d8c](https://github.com/halojerry/pounding/commit/9fc5d8c088c644f771457bf50658ac7c6e98c1dc))
* **app:** bind backend before startup services ([#397](https://github.com/halojerry/pounding/issues/397)) ([1ae944c](https://github.com/halojerry/pounding/commit/1ae944cb4239e898f910118885df9dfa793aec54))
* **app:** reuse conversation service for channel messages ([#531](https://github.com/halojerry/pounding/issues/531)) ([dce8053](https://github.com/halojerry/pounding/commit/dce80538b1575a35e512f93b6da0a5b2ab7b89c4))
* **app:** stop backend when desktop exits ([#433](https://github.com/halojerry/pounding/issues/433)) ([d300235](https://github.com/halojerry/pounding/commit/d30023562bcb6d413f428fcb1dec412929a72ab3))
* **app:** use process synchronize access for parent watcher ([#438](https://github.com/halojerry/pounding/issues/438)) ([95571f1](https://github.com/halojerry/pounding/commit/95571f1c9fcd69df6ec15d8f595178c4869c15d0))
* **assistant:** canonicalize rule file storage ([#625](https://github.com/halojerry/pounding/issues/625)) ([020a27a](https://github.com/halojerry/pounding/commit/020a27a77aeb2b5be7a2b4380aab8ae2686311c4))
* **assistant:** default agent_type to aionrs and resolve by provider (ELECTRON-1J1, ELECTRON-1KV) ([#325](https://github.com/halojerry/pounding/issues/325)) ([5c7fa04](https://github.com/halojerry/pounding/commit/5c7fa04bef47cf5bf2ea6badc66f723f0aafe1ec))
* **assistant:** expose auto-inject skills and preserve assistant rules ([#525](https://github.com/halojerry/pounding/issues/525)) ([f2e91fd](https://github.com/halojerry/pounding/commit/f2e91fde95ef3a84e43fbe22d71960d64686d3b0))
* **assistant:** filter generated assistants by installed agents ([#578](https://github.com/halojerry/pounding/issues/578)) ([5b7c366](https://github.com/halojerry/pounding/commit/5b7c366132006eb16e748e8fc5a0976da9a5b2a3))
* **assistant:** normalize avatar storage and identity ([#558](https://github.com/halojerry/pounding/issues/558)) ([155c278](https://github.com/halojerry/pounding/commit/155c278b7b603e8bf29e412295cec5ec50bb25fe))
* **assistant:** pin user_data_dir to runtime --data-dir ([#274](https://github.com/halojerry/pounding/issues/274)) ([0d49022](https://github.com/halojerry/pounding/commit/0d49022f90d7950e00e0dfdb60e389116177182d))
* **assistant:** preserve builtin override selections ([#535](https://github.com/halojerry/pounding/issues/535)) ([be4a81e](https://github.com/halojerry/pounding/commit/be4a81ef2927c0bedef3dbf22a69fc4e8f2ffd40))
* **assistant:** remove star office helper remnants ([#470](https://github.com/halojerry/pounding/issues/470)) ([eec23d9](https://github.com/halojerry/pounding/commit/eec23d9fed25765c43ca9f5f50df91cd53d01888))
* **assistant:** skip dirty assistant bootstrap records ([#615](https://github.com/halojerry/pounding/issues/615)) ([f48cbc7](https://github.com/halojerry/pounding/commit/f48cbc757f96e3595b00f4f81330dab958f41d28))
* **assistant:** stop legacy override sync from clobbering user toggles ([#634](https://github.com/halojerry/pounding/issues/634)) ([346700e](https://github.com/halojerry/pounding/commit/346700e1d62470f84eec94b1c58fd3516d1ea90e))
* **auth:** allow same-origin framing on office preview proxy routes ([#454](https://github.com/halojerry/pounding/issues/454)) ([3543dbd](https://github.com/halojerry/pounding/commit/3543dbdc0b8ca46682b84383d2b6c4aee9bdbdd6))
* **branding:** replace 'AionUi/AionUI' with 'POUNDING/poundingcore' in user-facing strings ([a95b643](https://github.com/halojerry/pounding/commit/a95b64369cc5428a1152f37078563fbe5bb1109d))
* bump codex-acp from 0.14.0 to 0.16.0 to fix release smoke test ([b50f29c](https://github.com/halojerry/pounding/commit/b50f29c93a193ca8b9ed41d12c81755e4da582ec))
* **butler:** correct three breaking field mismatches + update rule to CLI model ([#607](https://github.com/halojerry/pounding/issues/607)) ([b02bce6](https://github.com/halojerry/pounding/commit/b02bce62e5b7d847960be8d98e9f3b8c8e163e2c))
* canonicalize bundle_out path + update stale OpenClaw test ([6380a32](https://github.com/halojerry/pounding/commit/6380a320bc7ec7b7022dc258b6a2193f4b971f76))
* cargo fmt import ordering in agent_session_flow.rs ([c542c3f](https://github.com/halojerry/pounding/commit/c542c3f822843f8650c415be5c193a9e3a538622))
* **cc-switch:** add skip-if-complete to ensure_openclaw_live_config(); fix QR HTML qrToken→qr_token ([3c69f2f](https://github.com/halojerry/pounding/commit/3c69f2f7580cd3c9f1ef87d4be647a1d01ef1855))
* **cc-switch:** handle legacy Codex provider config TOML format ([339e1e6](https://github.com/halojerry/pounding/commit/339e1e618c1e18481231c5e0302fcc01f06ba761))
* change native-cli download URL from pounding to poundingcore ([d9d2bde](https://github.com/halojerry/pounding/commit/d9d2bde6e30234b1fb0828b3fe86b22c695f9f66))
* channel reply stream cold start ([#366](https://github.com/halojerry/pounding/issues/366)) ([b848ddf](https://github.com/halojerry/pounding/commit/b848ddff8fe5a973c67ee3c67187c6248d8c7455))
* **channel:** pass model via extra for non-aionrs conversations ([#298](https://github.com/halojerry/pounding/issues/298)) ([eb65dfe](https://github.com/halojerry/pounding/commit/eb65dfed2a9f2ea3d9cb11699c276ba76690c03e))
* **channel:** reuse stored credentials when re-enabling a plugin ([#458](https://github.com/halojerry/pounding/issues/458)) ([3920c58](https://github.com/halojerry/pounding/commit/3920c583db1c6a49d3209f685a8fb510967ca48a))
* **ci:** aioncore→poundingcore binary name, add feature branch triggers, update release-please ([8e13658](https://github.com/halojerry/pounding/commit/8e13658e73d4071b5e7719773c1c732a51287db6))
* **ci:** audit-check@v3→[@v2](https://github.com/v2), broaden branch trigger to feature/** ([5758046](https://github.com/halojerry/pounding/commit/575804609ded100fc16351c10de4a4997f27fab2))
* **ci:** cargo fmt + reconcile acp_config_options_e2e for CC-Switch ([2585cc6](https://github.com/halojerry/pounding/commit/2585cc6b78c8b57e122945e8e15d6663d9340b43))
* **ci:** prevent infinite -Pounding suffix loop in release workflow ([f23f3e8](https://github.com/halojerry/pounding/commit/f23f3e894c8f671e057d65bf1896e5a4b3d47b40))
* **ci:** remove AIONCORE_ALLOW_MAIN_MIGRATION_EDIT bypass ([243f644](https://github.com/halojerry/pounding/commit/243f644c5fb364bf0d4c07e5b79ccec4291a05ed))
* **ci:** restore main migration immutability guard ([7603d44](https://github.com/halojerry/pounding/commit/7603d44227f65f3d15e8b447c00c18bddd212314))
* **ci:** restore main migration immutability guard ([32121c2](https://github.com/halojerry/pounding/commit/32121c26b0ce572d498bac53ab6a86eedc3bceb4))
* **ci:** validate migrations against latest release ([5e21e3c](https://github.com/halojerry/pounding/commit/5e21e3c570705d0b1793d79ab3edc2572c84d610))
* classify missing MCP launcher runtimes ([#387](https://github.com/halojerry/pounding/issues/387)) ([fd8c20c](https://github.com/halojerry/pounding/commit/fd8c20cc0f6f36805cf5acc1fee3c708296d661a))
* clippy manual_unwrap_or_default in connection_test protocol ([028ce15](https://github.com/halojerry/pounding/commit/028ce152b581f855be2b010cbf73d80c5a7a6b39))
* co-locate npm config on staging drive to fix Windows EISDIR ([6edd7c6](https://github.com/halojerry/pounding/commit/6edd7c6ee86bdbd7518621d07a25cd1835de8f67))
* code review fixes — regex optimization + test cleanup ([8a4a47e](https://github.com/halojerry/pounding/commit/8a4a47ef032723831b33e97b6497f6a75f52b3ed))
* **conversation:** align workspace path availability handling ([#410](https://github.com/halojerry/pounding/issues/410)) ([30bc96b](https://github.com/halojerry/pounding/commit/30bc96b01632b2107279e81d641dfe020a3af873))
* **conversation:** avoid thinking/text segment id collision ([#342](https://github.com/halojerry/pounding/issues/342)) ([7aae690](https://github.com/halojerry/pounding/commit/7aae690063be683101b7bacc8e916e9d2b990ede))
* **conversation:** derive assistant runtime type from metadata ([#555](https://github.com/halojerry/pounding/issues/555)) ([236217d](https://github.com/halojerry/pounding/commit/236217d360ff67d0dcba906f287a34b954cb305d))
* **conversation:** partition temp workspaces and logs by date ([#560](https://github.com/halojerry/pounding/issues/560)) ([9bb1f33](https://github.com/halojerry/pounding/commit/9bb1f333065318c00da73c3a96f7fe92bea38d49))
* **conversation:** rebuild aionrs sessions from persisted runtime permission ([#661](https://github.com/halojerry/pounding/issues/661)) ([239c989](https://github.com/halojerry/pounding/commit/239c989a09c53ba85bebf714680fc924c8771f06))
* **conversation:** recover dead ACP turns after agent process loss ([#514](https://github.com/halojerry/pounding/issues/514)) ([e0ce4f4](https://github.com/halojerry/pounding/commit/e0ce4f4b67c44dff196d122216bd81bb42ca9ea9))
* **conversation:** return 404 for nonexistent conversation in get_slash_commands, get/set_config_options ([01d2346](https://github.com/halojerry/pounding/commit/01d234633490aa618d0426f0cf7edd3b388251ce))
* **conversation:** return 404 for set_model on nonexistent conversation ([82f398f](https://github.com/halojerry/pounding/commit/82f398fe9dcbc06a438f107bfa1beb62f2fb4000))
* **conversation:** unify provider/model resolution across send/cron paths (ELECTRON-1HX, ELECTRON-1HM) ([#326](https://github.com/halojerry/pounding/issues/326)) ([71e275a](https://github.com/halojerry/pounding/commit/71e275ae3295d88c9da5eacf9f959d4683b4043d))
* **conversation:** upsert streaming tool calls (AIO-30) ([#484](https://github.com/halojerry/pounding/issues/484)) ([a0b3737](https://github.com/halojerry/pounding/commit/a0b3737bf6a60c6f5483d4112dc4f4f733a9e6fa))
* **cron:** apply custom assistant rules in scheduled runs ([#495](https://github.com/halojerry/pounding/issues/495)) ([3840b77](https://github.com/halojerry/pounding/commit/3840b77f4f4dc26b58481868507e07e13fb9fbd1))
* **cron:** enforce full-auto mode for scheduled tasks ([#576](https://github.com/halojerry/pounding/issues/576)) ([cf0a9bd](https://github.com/halojerry/pounding/commit/cf0a9bd88ac295fe8b40a6c1f9f21174b574718d))
* **cron:** lock team cron execution mode ([#562](https://github.com/halojerry/pounding/issues/562)) ([56f3873](https://github.com/halojerry/pounding/commit/56f38734844164707782b795627a8d65ff1b3c16))
* **cron:** preserve existing conversation jobs across lifecycle changes ([#572](https://github.com/halojerry/pounding/issues/572)) ([fa4217a](https://github.com/halojerry/pounding/commit/fa4217a6d4ba0cde4d4c7d0d5460969b94eb6c4a))
* **cron:** restore create command heading ([#547](https://github.com/halojerry/pounding/issues/547)) ([1a30f77](https://github.com/halojerry/pounding/commit/1a30f7710de2c98856f7256811543c1121dddc76))
* **cron:** retry busy jobs from runtime state ([#459](https://github.com/halojerry/pounding/issues/459)) ([9918058](https://github.com/halojerry/pounding/commit/9918058788e07508ee61fc841e4c85cf757b8bb6))
* **cron:** route skill scheduling through helper ([#553](https://github.com/halojerry/pounding/issues/553)) ([c57970f](https://github.com/halojerry/pounding/commit/c57970fed387ba895dd934f85c4c59af63da6cfa))
* **cron:** run jobs through conversation service ([#546](https://github.com/halojerry/pounding/issues/546)) ([b36fb5c](https://github.com/halojerry/pounding/commit/b36fb5c471b19edefd0b63dc2acf3e3d4c2c52ae))
* **database:** require explicit corrupted database recovery ([#563](https://github.com/halojerry/pounding/issues/563)) ([203bd1b](https://github.com/halojerry/pounding/commit/203bd1b574438cf730c351879a773a82548b972c))
* **db:** cast REAL timestamps to INTEGER in conversations table ([#275](https://github.com/halojerry/pounding/issues/275)) ([92e5fa9](https://github.com/halojerry/pounding/commit/92e5fa9f75065b85b5533476d0fbb836b0145b4e))
* **db:** prevent duplicate migration versions ([af88855](https://github.com/halojerry/pounding/commit/af88855a5e1610797689debd81755136f740cc2d))
* **db:** prevent duplicate migration versions ([39b74ba](https://github.com/halojerry/pounding/commit/39b74ba1befeb052a673edaf9f05313c774fc1d7))
* **db:** remove duplicate migration 010_add_pounding_cli.sql (replaced by 013) ([8bc19aa](https://github.com/halojerry/pounding/commit/8bc19aac828a57de5d0c95f5b93cd82fe1b62fc1))
* **db:** rename 010_add_pounding_cli.sql → 015 to resolve migration version conflict ([2ebedda](https://github.com/halojerry/pounding/commit/2ebedda406db1502b14ddb00e1682967e1f33a52))
* **db:** repair legacy handoff schema drift ([#516](https://github.com/halojerry/pounding/issues/516)) ([292e5f2](https://github.com/halojerry/pounding/commit/292e5f2d6fc727f41f4164d5f51cfa37c103b060))
* **db:** serialize migrations with fs2 file lock to avoid concurrent race (ELECTRON-1KK) ([#329](https://github.com/halojerry/pounding/issues/329)) ([8550851](https://github.com/halojerry/pounding/commit/85508518b1df99b48d9ea09f474ed4d64437e8af))
* defend against npm packages with broken exports/main paths in smoke test ([3822757](https://github.com/halojerry/pounding/commit/38227579c686c370681602ae38dd18323bb7a71c))
* **deps:** update quinn-proto for RustSec advisory ([#508](https://github.com/halojerry/pounding/issues/508)) ([05df6f7](https://github.com/halojerry/pounding/commit/05df6f7c2d924b94d1514bcee4ff835ea0e0b0fb))
* disable native CLI downloads (hermes/opencode/openclaw) that always return 404 ([348e1e1](https://github.com/halojerry/pounding/commit/348e1e1dcff30628bc3febe914c453f8079453c6))
* eliminate remaining POUNDING-introduced warnings ([387b857](https://github.com/halojerry/pounding/commit/387b8571a7696364c129eeb0fdc94cd05ee70304))
* enforce workspace path whitespace errors across create and runtime ([#381](https://github.com/halojerry/pounding/issues/381)) ([9448a36](https://github.com/halojerry/pounding/commit/9448a36cec456648bd87a680e9dc84083038a63a))
* ensure config.env overrides agent_spawn_env for CLAUDE_CODE_EXECUTABLE ([5d146d6](https://github.com/halojerry/pounding/commit/5d146d6e1146251e23b6daf45e5fbec03d6f242e))
* **error:** canonicalize boundary errors ([#415](https://github.com/halojerry/pounding/issues/415)) ([84e04e1](https://github.com/halojerry/pounding/commit/84e04e122dad19eee712af29d3b5bd3f631a6fe1))
* expose managed resource preparation failure details ([#430](https://github.com/halojerry/pounding/issues/430)) ([e010024](https://github.com/halojerry/pounding/commit/e010024fce3975fe5f6930c24377bde9f636b55b))
* extend CC-Switch model/env injection to Hermes backend ([c3da25c](https://github.com/halojerry/pounding/commit/c3da25cac1b83745c0960bbe7bda37fa4147bab5))
* **extension:** fall back to directory copy when Windows symlink fails (Sentry I1) ([#331](https://github.com/halojerry/pounding/issues/331)) ([d65a0a1](https://github.com/halojerry/pounding/commit/d65a0a13449f0941a68adbeae950f094e2545bfe))
* **file:** lazy load browse roots ([#406](https://github.com/halojerry/pounding/issues/406)) ([668c562](https://github.com/halojerry/pounding/commit/668c5623ffd30243cb0ed72e670eecb578fb22cc))
* **file:** strip Windows verbatim prefix from /api/fs/browse paths ([#453](https://github.com/halojerry/pounding/issues/453)) ([f8c3f95](https://github.com/halojerry/pounding/commit/f8c3f950f9897c4e13ae7bb1dbb7816017b86480))
* **file:** trust local workspace roots for fs routes ([#527](https://github.com/halojerry/pounding/issues/527)) ([8e6f32f](https://github.com/halojerry/pounding/commit/8e6f32fe1eda91177d794dca80c87cff3cd970fa))
* final clippy::collapsible_if fix + cargo fmt --all ([021023c](https://github.com/halojerry/pounding/commit/021023ca6a8ccce51888fe3ea18cc7a19021e16b))
* final clippy::collapsible_if fix + cargo fmt --all ([9b79932](https://github.com/halojerry/pounding/commit/9b79932d9b2fdcd26c3d02f968930dcb45416837))
* final clippy::collapsible_if fix + cargo fmt --all ([e61f1e6](https://github.com/halojerry/pounding/commit/e61f1e638bcf043f73677b7872b181e3495ede4b))
* final clippy::collapsible_if fix + cargo fmt --all ([b52c94c](https://github.com/halojerry/pounding/commit/b52c94c01d0126bead96f88743d11ce6a8d6bd53))
* final clippy::collapsible_if fix + cargo fmt --all ([f466445](https://github.com/halojerry/pounding/commit/f466445fe869a4be5b17bfc477aeb1ebab87fe97))
* final clippy::collapsible_if fix + cargo fmt --all ([bc70a90](https://github.com/halojerry/pounding/commit/bc70a90ded709b6544a7ef0c1b1e458e58225e04))
* handle absolute bin paths in smoke test (codex-acp) ([7196b02](https://github.com/halojerry/pounding/commit/7196b02255f5caa844941806f808e5bbea67604b))
* handle Hermes yolo fallback correctly ([#428](https://github.com/halojerry/pounding/issues/428)) ([e10d264](https://github.com/halojerry/pounding/commit/e10d26460ac6dabf292f8b1edd7eeb1c1ffd5cad))
* harden ACP image path handling ([#477](https://github.com/halojerry/pounding/issues/477)) ([c79b5a8](https://github.com/halojerry/pounding/commit/c79b5a8a010fee82219579873a062bcca5c71fc2))
* harden managed ACP bundle preparation and builtin CLI availability ([#426](https://github.com/halojerry/pounding/issues/426)) ([e0121f9](https://github.com/halojerry/pounding/commit/e0121f938e0160f48d2f57e9205f78bf31b92233))
* improve OpenClaw diagnostics + Codex session rebuild logging ([004f230](https://github.com/halojerry/pounding/commit/004f2309c8d64d22454c7fb0a2318d554c5e1275))
* increase idle timeout to 15min + inject OpenClaw env vars in generic spawn path ([d1f53e2](https://github.com/halojerry/pounding/commit/d1f53e299645fa15c1a4734b7bf1d16991d2fea1))
* isolate ACP cancel turn completion ([#461](https://github.com/halojerry/pounding/issues/461)) ([ea01ee6](https://github.com/halojerry/pounding/commit/ea01ee6849d66dad698fee48f6374233d23985ae))
* load skills in custom workspaces ([#506](https://github.com/halojerry/pounding/issues/506)) ([d73c398](https://github.com/halojerry/pounding/commit/d73c39855c1863e0606aedcb6c4ef8ebffeec8cc))
* make cancel endpoint accept optional turn_id to prevent 400 errors ([c0a4b70](https://github.com/halojerry/pounding/commit/c0a4b7030ed74cbec58d7f115d05bdf00f3db9e6))
* make native CLI preparation non-fatal in Release CI ([4f6175f](https://github.com/halojerry/pounding/commit/4f6175f7c4bc7d85784deeeed0fc48dc54f017a9))
* make smoke test non-fatal (EISDIR on Windows node --check) ([5964962](https://github.com/halojerry/pounding/commit/596496288498d7fdc7c131702663be351c1ce699))
* **managed-resources:** emit bundled resource manifest ([#617](https://github.com/halojerry/pounding/issues/617)) ([64b5062](https://github.com/halojerry/pounding/commit/64b506239639c632eb5f6acb4495e58e74c64167))
* **mcp:** clean up stdio test process trees ([#368](https://github.com/halojerry/pounding/issues/368)) ([3481956](https://github.com/halojerry/pounding/commit/3481956d4c7e2148302d9f31ecef5a88357c38e8))
* **mcp:** support aionrs config path subcommand with legacy fallback ([#568](https://github.com/halojerry/pounding/issues/568)) ([72cfba1](https://github.com/halojerry/pounding/commit/72cfba1909d663117615a595316804c7707bdfd3))
* missing tempfile:: prefix on tempdir() call ([7e7ba4a](https://github.com/halojerry/pounding/commit/7e7ba4abcdcb64c53eeecdde0219f3f391bb41cc))
* **model_fetcher:** extract first key from multi-line api_key for HTTP requests ([#593](https://github.com/halojerry/pounding/issues/593)) ([1161647](https://github.com/halojerry/pounding/commit/116164756544306ef8ac257106a03e665c85cf3d))
* **native-cli:** replace dead download fallback with clear install instructions ([33fb83f](https://github.com/halojerry/pounding/commit/33fb83f81507a4a41445f13eb7462bc62601078b))
* **native-cli:** update native CLI version pins to official latest ([1f774d1](https://github.com/halojerry/pounding/commit/1f774d168f531aaead61861f0b702c012278d21e))
* **new-api:** fetch only POUNDING group models, not all models ([2ccfecc](https://github.com/halojerry/pounding/commit/2ccfecc2166e12fc30f07ed5ff28916c52adfce9))
* **new-api:** rewrite fetch_models_at_url — single parse via text() ([e430bd6](https://github.com/halojerry/pounding/commit/e430bd69319f300b97c6968048c8fa4323731554))
* **new-api:** use ?grouped=true + extract POUNDING group models ([22cdc9c](https://github.com/halojerry/pounding/commit/22cdc9cd88a5fd405c88ffe981be9e713fd4a8f9))
* **office:** fetch officecli installer from official mirror before GitHub ([#463](https://github.com/halojerry/pounding/issues/463)) ([08fbc6f](https://github.com/halojerry/pounding/commit/08fbc6f12d154d5419ae1b092a1a9352ee64250e))
* **office:** probe star-office preferred_url host as given ([#456](https://github.com/halojerry/pounding/issues/456)) ([3c2149c](https://github.com/halojerry/pounding/commit/3c2149ca92aad8a0e19fae0d8083083500f60267))
* **office:** resolve officecli shim from node_modules/.bin after npm prefix install ([#440](https://github.com/halojerry/pounding/issues/440)) ([2fe76ee](https://github.com/halojerry/pounding/commit/2fe76eebbaab1d323b4f81acaff8187a0c00bac7))
* **office:** restore OfficeCLI installer resolution ([#444](https://github.com/halojerry/pounding/issues/444)) ([009e133](https://github.com/halojerry/pounding/commit/009e133e9e914556a579f27a3671fb5ff47333f7))
* prepare managed acp tools locally without cdn ([#408](https://github.com/halojerry/pounding/issues/408)) ([2a48ae3](https://github.com/halojerry/pounding/commit/2a48ae34a498ff0e5bd37d0eedee81d2ea7d0154))
* preserve ACP config catalogs on resume ([#570](https://github.com/halojerry/pounding/issues/570)) ([a9c1955](https://github.com/halojerry/pounding/commit/a9c19553bad1da3283f5dfad1972cd1ed1992546))
* preserve assistant snapshot and skill wiring for cron ([#473](https://github.com/halojerry/pounding/issues/473)) ([2d47d8c](https://github.com/halojerry/pounding/commit/2d47d8cca71c4d0fdc3d1c2b93916c03b8c3b42c))
* preserve cron timezone on legacy schedule updates ([#344](https://github.com/halojerry/pounding/issues/344)) ([6328b76](https://github.com/halojerry/pounding/commit/6328b7683133a6f74e87add6c11386ebbb0dad49))
* preserve Linux GLIBC baselines ([#573](https://github.com/halojerry/pounding/issues/573)) ([ab6e227](https://github.com/halojerry/pounding/commit/ab6e227504c40f78823988d4c10af8fd153cc47c))
* **provider:** preserve automatic vision detection ([08696fd](https://github.com/halojerry/pounding/commit/08696fd0b46794497c7bf70473874753a66c1925))
* QR login query-param fallback + clippy fixes ([39a3c05](https://github.com/halojerry/pounding/commit/39a3c0502af1c7f566230abf99101a7ba8fd12db))
* QR login query-param fallback + clippy fixes ([24ff0e5](https://github.com/halojerry/pounding/commit/24ff0e5ce8bdea7ab3687eba951afc5a6e753104))
* **realtime:** forward id and read nested data in subscribe-show-open ([#323](https://github.com/halojerry/pounding/issues/323)) ([7dc222f](https://github.com/halojerry/pounding/commit/7dc222fd444e3869e7b44101fa709e4704ad0a7e))
* recover deleted conversation workspaces ([#379](https://github.com/halojerry/pounding/issues/379)) ([759afb8](https://github.com/halojerry/pounding/commit/759afb88ed404a055abd686c427e5805161b812b))
* refactor npm config into NpmConfig struct to fix clippy too_many_arguments ([db6dbc1](https://github.com/halojerry/pounding/commit/db6dbc1df43a9d5148404dae236ae1bf81f87d3c))
* remove unused imports and constant (ACP_FINISH_GRACE_MS, Duration, sleep) ([9fd8292](https://github.com/halojerry/pounding/commit/9fd8292587260355307b2f21c32e50ae2f7ff2a6))
* rename DB aionui-backend.db → pounding-backend.db, accept numeric user.id ([1d8ca3f](https://github.com/halojerry/pounding/commit/1d8ca3f839ca130767acb6ed5232c1fb150f6b09))
* renumber POUNDING migrations 007→010, 008→011 to avoid upstream collision ([dc50018](https://github.com/halojerry/pounding/commit/dc50018124649c43a4fdc1bc0390b0288f3a54f9))
* renumber upstream migrations (020→023, 021→024) to avoid conflicts ([904219b](https://github.com/halojerry/pounding/commit/904219bb1871b63bba0595567cfb4f1fafaff88d))
* repair invalid UTF-8 agent metadata cache fields ([#526](https://github.com/halojerry/pounding/issues/526)) ([91969cd](https://github.com/halojerry/pounding/commit/91969cd765dbecf962ba3c986eb271dfc8208c0b))
* resolve ACP backends from metadata ([#559](https://github.com/halojerry/pounding/issues/559)) ([6c15bb7](https://github.com/halojerry/pounding/commit/6c15bb765f8c84baddd89830839c832424ef1789))
* resolve compile errors after v2.1.34 merge ([1374177](https://github.com/halojerry/pounding/commit/1374177242b8cca41a81eff115dd6a6052906c18))
* resolve duplicate imports and undefined normalized_model_id ([d62f5c7](https://github.com/halojerry/pounding/commit/d62f5c715f5ce22ab61c2894342ad0a04812c45e))
* restore full repo tree after accidental deletion ([15e7d8e](https://github.com/halojerry/pounding/commit/15e7d8e6616663c17f5d28684e8bf1ae6e4a32dd))
* restore upstream legacy DB name aionui.db in copy function and tests ([c77d7cb](https://github.com/halojerry/pounding/commit/c77d7cb4d41b22e4b595f13bf47612e4a45b8721))
* revert broken 001 migration change and clean up unused imports ([45f7990](https://github.com/halojerry/pounding/commit/45f79903767e16176e719851a469a921a9668229))
* robust smoke test path resolution + conversation existence check for get_model ([9f5a117](https://github.com/halojerry/pounding/commit/9f5a117a411c7c41e63616ec54d01eb2dfc1dedf))
* **runtime:** create node symlink in bundled bun directory (ELECTRON-1EY) ([#310](https://github.com/halojerry/pounding/issues/310)) ([c0ad26b](https://github.com/halojerry/pounding/commit/c0ad26bb74008609a8dac815758aabc2284a8066))
* **runtime:** harden managed Node command resolution ([#565](https://github.com/halojerry/pounding/issues/565)) ([e69b83a](https://github.com/halojerry/pounding/commit/e69b83a836b369b4244a04b64f931bea1dd54743))
* **runtime:** make CLI detection work on Windows ([#276](https://github.com/halojerry/pounding/issues/276)) ([35bd121](https://github.com/halojerry/pounding/commit/35bd1217425a2e0d51f3e8f8e2f53ea37151c1eb))
* **runtime:** protect active ACP tasks from idle cleanup ([#561](https://github.com/halojerry/pounding/issues/561)) ([1fa7a54](https://github.com/halojerry/pounding/commit/1fa7a543e8fd4cec7e423443cbd6299de6a761ad))
* **runtime:** report bundled resource installation failures ([#420](https://github.com/halojerry/pounding/issues/420)) ([bc4b7d9](https://github.com/halojerry/pounding/commit/bc4b7d9315727b1e4fe00cb54c1230828dd37cf1))
* **runtime:** update Claude ACP package ([#599](https://github.com/halojerry/pounding/issues/599)) ([cf69332](https://github.com/halojerry/pounding/commit/cf693323913c31d3276a5e103b434c6ca51b519e))
* **runtime:** update managed Codex ACP package ([#598](https://github.com/halojerry/pounding/issues/598)) ([1bb2be7](https://github.com/halojerry/pounding/commit/1bb2be72a040d16f284d4a0b5b2de670aa2f864b))
* scope bundled ACP output under tool directories ([#431](https://github.com/halojerry/pounding/issues/431)) ([d079395](https://github.com/halojerry/pounding/commit/d079395b0679d5b9450497a4d088bc478c5cf45f))
* **shell:** reveal file via FileManager1 D-Bus on Linux ([#466](https://github.com/halojerry/pounding/issues/466)) ([98c75ec](https://github.com/halojerry/pounding/commit/98c75ecc1bf20263f9bb682d8729d0924060f178))
* **shell:** support UNC paths in Windows terminal ([#411](https://github.com/halojerry/pounding/issues/411)) ([a041953](https://github.com/halojerry/pounding/commit/a04195329996b921cee811066994efb885b833e1))
* **skill:** raise import size limits ([#564](https://github.com/halojerry/pounding/issues/564)) ([50d9aff](https://github.com/halojerry/pounding/commit/50d9affe53ad64e994564a31215caab428eb7094))
* **skills:** correct AionUi Butler skill drift against current backend ([#557](https://github.com/halojerry/pounding/issues/557)) ([41c2c94](https://github.com/halojerry/pounding/commit/41c2c9426eefb2ce29de4a9f5b4e10c862a63994))
* **skills:** correct aionui-config butler skill drift (2026-07) ([#584](https://github.com/halojerry/pounding/issues/584)) ([e72e03f](https://github.com/halojerry/pounding/commit/e72e03ff6e1366f705352bcefec474887a85adfa))
* **skills:** quote marketing-skills description (invalid YAML frontmatter) ([262bdd9](https://github.com/halojerry/pounding/commit/262bdd9cf7228261079cf0fe5e91fe5d06b97454))
* **skills:** repair butler endpoint drift + add cron scheduling ([#550](https://github.com/halojerry/pounding/issues/550)) ([88bcff3](https://github.com/halojerry/pounding/commit/88bcff3c08ebcd5e5dff8f16ba9c68fa313ef55f))
* **skills:** sync AionUi Butler skills + rule with current backend ([#520](https://github.com/halojerry/pounding/issues/520)) ([5603b9a](https://github.com/halojerry/pounding/commit/5603b9a77857b08d99d45c02eeeeb4d6d1e1e98a))
* skip npm packages with absolute main/exports paths in smoke test ([115320d](https://github.com/halojerry/pounding/commit/115320d9ed1c6c4a6ddad75152eae021dc686684))
* split streamed message segments around tool boundaries ([#339](https://github.com/halojerry/pounding/issues/339)) ([476b1cc](https://github.com/halojerry/pounding/commit/476b1cc86f2adef8998477a666809dda50afca3e))
* **startup:** add backend readiness diagnostics ([#346](https://github.com/halojerry/pounding/issues/346)) ([ae8e01c](https://github.com/halojerry/pounding/commit/ae8e01c927118779bbad64da42a6b81aef27e9c9))
* **startup:** add startup phase diagnostics ([#388](https://github.com/halojerry/pounding/issues/388)) ([d24d027](https://github.com/halojerry/pounding/commit/d24d02726e03b852c8ee87caa872ed1605509143))
* **startup:** make concurrent aioncore startup safe over one data directory ([#657](https://github.com/halojerry/pounding/issues/657)) ([2a64b55](https://github.com/halojerry/pounding/commit/2a64b55e1ab52f789dcb3a715ef0a940b35a20b3))
* stop defaulting aionrs max tokens ([22bc24b](https://github.com/halojerry/pounding/commit/22bc24b1f30ef4d475ccada7d36b3ee977054eba))
* **stt:** STT compatibility fixes for Groq Whisper and AionUI web frontend ([#400](https://github.com/halojerry/pounding/issues/400)) ([4c3fa09](https://github.com/halojerry/pounding/commit/4c3fa094087c8479d0c2975ec896ce46fb37abca))
* **stt:** treat blank base_url as unset and log malformed config ([#448](https://github.com/halojerry/pounding/issues/448)) ([f6b653b](https://github.com/halojerry/pounding/commit/f6b653bbdd5822dcd1b52790f0cf28db65115011))
* sync advertised.config_options after mode/model switch, add MCP connection test diagnostics ([5c9e199](https://github.com/halojerry/pounding/commit/5c9e199c0771d1e4988c5080de7b304f87cb4b51))
* **system:** apply keep-awake client preference ([#642](https://github.com/halojerry/pounding/issues/642)) ([a6a290d](https://github.com/halojerry/pounding/commit/a6a290dd374a37eca73fc008c25bd6780a0e1f54))
* **team-mcp:** use fixed server name to stay within 64-char tool limit (ELECTRON-1JY) ([#336](https://github.com/halojerry/pounding/issues/336)) ([eaa3aa0](https://github.com/halojerry/pounding/commit/eaa3aa098816191d8531ef0f1de12292e5e47cc5))
* **team:** broadcast Stopped status on idle-cleanup team reclaim ([#640](https://github.com/halojerry/pounding/issues/640)) ([024a3a5](https://github.com/halojerry/pounding/commit/024a3a578936af0c59ed5aeed7bc1b4c20d990ea))
* **team:** inherit workspace for spawned agents ([#413](https://github.com/halojerry/pounding/issues/413)) ([82b31c5](https://github.com/halojerry/pounding/commit/82b31c5fbdb1e30a580865b4c441b1ac93ec5181))
* **team:** model routing + schema unification + lazy warm mode persistence ([#286](https://github.com/halojerry/pounding/issues/286)) ([199a392](https://github.com/halojerry/pounding/commit/199a392caca600ef215bb2ae71bfd82bda7bb744))
* **team:** pass workspace from CreateTeamRequest to agent conversations ([#273](https://github.com/halojerry/pounding/issues/273)) ([f4e3f32](https://github.com/halojerry/pounding/commit/f4e3f32e3a1a9f8fa34769205fa031b6037af00e))
* **team:** retry handoff turns after runtime release ([#480](https://github.com/halojerry/pounding/issues/480)) ([77d252f](https://github.com/halojerry/pounding/commit/77d252fdd7e43c740043bc3f7963a06a1461fec8))
* **test:** aionrs logo assertion expects POUNDING heart, not aion.svg ([523d8c1](https://github.com/halojerry/pounding/commit/523d8c1e9f2430a93a38a3bcdb9e51838d2ed4ac))
* **test:** command_ack test uses generic option, not CC-Switch model ([2945488](https://github.com/halojerry/pounding/commit/294548829cc0deb4588709b59382b1d03c3bf035))
* **test:** restore MockAgent.set_mode + align set_config_option tests ([cb66abf](https://github.com/halojerry/pounding/commit/cb66abf40368136a4f4774f49058f435a37d2735))
* **test:** update avatar test after fixing word-form-creator emoji avatar ([df952d6](https://github.com/halojerry/pounding/commit/df952d62664d9efd54a0d32e2fa1caa845fa6e50))
* update branding skill path and suppress managed-runtime 404 ([8b455a6](https://github.com/halojerry/pounding/commit/8b455a630e07168f7458a6d6453eb86245be4007))
* update check-branding.sh for renamed migration and skill paths ([13258ea](https://github.com/halojerry/pounding/commit/13258eaf2112323de2c4fab2079799c003daf6eb))
* update smoke test to create actual file for entrypoint check ([7759177](https://github.com/halojerry/pounding/commit/775917795962fcec2826c71cbee9c90080341ad3))
* use Path::is_absolute() instead of starts_with('/') for Windows smoke test ([4ab7e7c](https://github.com/halojerry/pounding/commit/4ab7e7c03bdf8dcbcbafe3fba1a1bb904e41a63c))
* use provider and model protocol to determine llm request. ([37f76a8](https://github.com/halojerry/pounding/commit/37f76a8bf1ba8aafabb5dd6b6062da40173ef010))
* use temp_dir() for bundle staging to avoid Windows MAX_PATH ([e04fd5a](https://github.com/halojerry/pounding/commit/e04fd5acdb2b8dcc47b919cdaabd29f885466637))
* validate managed ACP packages via real entrypoints ([#429](https://github.com/halojerry/pounding/issues/429)) ([77221dd](https://github.com/halojerry/pounding/commit/77221ddddd883c56b954ca5cfea0f98038754efe))
* validate skill frontmatter as yaml ([#512](https://github.com/halojerry/pounding/issues/512)) ([6b46055](https://github.com/halojerry/pounding/commit/6b460552b63cdb6242703831c25443d9153fc25e))
* **windows:** handle runtime process lifecycle ([399f920](https://github.com/halojerry/pounding/commit/399f920c31ab4d738ffa32b5ebcff9416ba44e6f))


### Performance Improvements

* **team:** lazy warm — only start agent processes on first message ([#282](https://github.com/halojerry/pounding/issues/282)) ([6281f31](https://github.com/halojerry/pounding/commit/6281f31ac6a2656c1af51891589770f4583e00c2))


### Code Refactoring

* **app:** extract CLI definitions to cli.rs ([#280](https://github.com/halojerry/pounding/issues/280)) ([5685d52](https://github.com/halojerry/pounding/commit/5685d5237b8f51c70e80895b1c654325c958196e))
* **app:** introduce commands/ module with layered bootstrap for subcommands ([#283](https://github.com/halojerry/pounding/issues/283)) ([1216597](https://github.com/halojerry/pounding/commit/12165971cfae61d85376c102ef9f9afc5a7c5bbf))
* **app:** organize CLI command boundaries ([#423](https://github.com/halojerry/pounding/issues/423)) ([cc84d52](https://github.com/halojerry/pounding/commit/cc84d523f1014978b0fb9c880842d4fd29330925))
* **app:** replace argv sniffing with clap Subcommand for mcp-* helpers ([#277](https://github.com/halojerry/pounding/issues/277)) ([c3d137c](https://github.com/halojerry/pounding/commit/c3d137c9e5fdcb12e29d5ca7abd6a0585bbc6c8d))
* **app:** split monolithic lib.rs/main.rs into per-module files ([#284](https://github.com/halojerry/pounding/issues/284)) ([f3462cb](https://github.com/halojerry/pounding/commit/f3462cbb1d6d830a3a368a76b2d9ea6424f21b64))
* **assistant:** finalize unified governance storage ([#449](https://github.com/halojerry/pounding/issues/449)) ([aba2d2a](https://github.com/halojerry/pounding/commit/aba2d2acc0a855152ae372c04b4249e956fc4cbf))
* **auth:** replace newapi-login proxy with sync-credentials endpoint ([3504545](https://github.com/halojerry/pounding/commit/350454581fc6e855e30052f829835d77eff2afa0))
* centralize agent runtime session context building ([#419](https://github.com/halojerry/pounding/issues/419)) ([b21f833](https://github.com/halojerry/pounding/commit/b21f8334e2955c73be4acb2beb76c79133e2120a))
* centralize runtime turn lifecycle ([#421](https://github.com/halojerry/pounding/issues/421)) ([282c68c](https://github.com/halojerry/pounding/commit/282c68cb43a6c06862ee61c7441a9dd52a3008b7))
* **error:** finish ApiError phase3 ([#398](https://github.com/halojerry/pounding/issues/398)) ([37523ab](https://github.com/halojerry/pounding/commit/37523ab628abdfaa29eaf5b0b713cb2251062146))
* **error:** migrate phase2 service errors ([#395](https://github.com/halojerry/pounding/issues/395)) ([c6c42ee](https://github.com/halojerry/pounding/commit/c6c42eea051083c94eb822163149de6fef2387a3))
* four-layer architecture (connect / conv / biz) ([#349](https://github.com/halojerry/pounding/issues/349)) ([2a11285](https://github.com/halojerry/pounding/commit/2a11285e316ffc7f0076d385dad8e09a4af2de4b))
* rename binary from aioncli to aioncore ([#293](https://github.com/halojerry/pounding/issues/293)) ([ae78cd1](https://github.com/halojerry/pounding/commit/ae78cd19f599fb3c8845ba5d3e208a75bf310368))
* rename binary from aionui-backend to aioncli ([#289](https://github.com/halojerry/pounding/issues/289)) ([30eeca3](https://github.com/halojerry/pounding/commit/30eeca37661441ba9474aa7dc51ca911abda0bfb))
* **runtime:** remove legacy Bun runtime support ([#623](https://github.com/halojerry/pounding/issues/623)) ([01b5eed](https://github.com/halojerry/pounding/commit/01b5eed0db886e05b652c4633c9acd337087e1ab))


### Documentation

* add CLI version audit reference (dual-runtime + pins) ([12f6129](https://github.com/halojerry/pounding/commit/12f6129d76e68925e46ff49ed0719d18db084481))
* catch up with aionui-backend → AionCore rename ([#301](https://github.com/halojerry/pounding/issues/301)) ([40a7e83](https://github.com/halojerry/pounding/commit/40a7e83618bb62b145378e333e26b66dc0061c89))
* clarify production logging guidance ([#460](https://github.com/halojerry/pounding/issues/460)) ([118ed03](https://github.com/halojerry/pounding/commit/118ed03b5393ec87edf8801ed7395d917c87855a))
* de-stale AGENTS.md and guard against symbol-anchored rules ([#649](https://github.com/halojerry/pounding/issues/649)) ([9bd188c](https://github.com/halojerry/pounding/commit/9bd188cd89990413bc9e70cc9392ac1a1c5fdc91))
* **skills:** add cross-platform notes so Windows users translate shell examples ([#489](https://github.com/halojerry/pounding/issues/489)) ([e03b030](https://github.com/halojerry/pounding/commit/e03b0309c9fcd4914175d22787efa90e9599c8ec))
