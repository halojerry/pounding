...
<p align="center">
  <a href="https://x.com/POUNDING/status/2079493379914961069">
    <img src="../../resources/kimi/contributor-bonus-black-blue.jpg" alt="POUNDING × Kimi Katkıda Bulunan Bonusu" width="600">
  </a>
</p>

<p align="center">
  🎁 <strong>POUNDING × Kimi Ortaklığı</strong>: Katkıda bulunanlara <strong>ücretsiz premium Kimi "Allegretto" planları (aylık $39 · ¥199 değerinde)</strong>!
</p>

<h3 align="center">
  <a href="https://x.com/POUNDING/status/2079493379914961069">Kampanya detaylarını ve talep yöntemini görün →</a>
</h3>

<p align="center">
  <sub><strong>Kimi K3</strong> yayında ve POUNDING'de kutudan çıktığı gibi çalışıyor — <a href="https://www.kimi.com/code?aff=aionui" target="_blank">Kimi For Coding planı edinin</a> veya API anahtarı alın (<a href="https://platform.kimi.ai?aff=aionui" target="_blank">Global</a> / <a href="https://platform.kimi.com?aff=aionui" target="_blank">Çin</a>)</sub>
</p>
...
[🤔 Neden POUNDING'yi Seçmelisiniz?](#-neden-aionui-claude-cowork-yerine) ·
...
**POUNDING sadece bir sohbet istemcisi değil.** AI Agents'ın bilgisayarınızda sizinle çalıştığı bir Cowork platformudur — dosya okuma, kod yazma, web'de gezinme ve görevleri otomatikleştirme. Agent'ın yaptığı her şeyi görürsünüz ve her zaman kontrol sizdedir.

|                                        | Geleneksel AI Sohbet İstemcileri | **POUNDING (Cowork)**                                                                                                             |
| :------------------------------------- | :------------------------------- | :------------------------------------------------------------------------------------------------------------------------------ |
...
POUNDING tam bir AI Agent motoru ile birlikte gelir. CLI Agent'ları ayrı olarak kurmanızı gerektiren araçların aksine, **POUNDING kurduğunuz anda çalışır**.
...
Zaten Claude Code, Codex, Hermes Agent veya OpenClaw kullanıyorsanız, POUNDING bunları otomatik olarak algılar ve hepsiyle Cowork yapmanıza izin verir — yerleşik Agent ile birlikte.

**Desteklenen Agents:** Yerleşik Agent (sıfır kurulum) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI (aionrs, POUNDING ile birlikte dağıtılan Rust tabanlı arka uç servisi) • Snow CLI • Hermes Agent • Cursor Agent ve daha fazlası
...
- **Paralel çoklu agent çalıştırma** — Leader görevleri alt görevlere bölerek paralel çalışan Teammate Agent'lara devreder; her Teammate ACP (Agent Communication Protocol, POUNDING'nin çoklu agent koordinasyon katmanı), Gemini veya Aionrs aracılığıyla kendi modelini kullanır
...
Diğer AI uygulamaları size API anahtarınızla bir sohbet kutusu verir. **POUNDING size tam bir Cowork Agent verir.**
...
Aynı Agent yetenekleri — dosya okuma/yazma, web arama, görüntü oluşturma, araç kullanımı — hangi modelin güç verdiğine bakılmaksızın. POUNDING bulut hizmetleri ve yerel dağıtımlar dahil **30+ AI platformunu** destekler.
...
POUNDING ayrıca [NewAPI](https://github.com/QuantumNous/new-api) ağ geçidi hizmetini destekler — çeşitli LLM'leri toplayan ve dağıtan birleşik bir AI model merkezi. Çeşitli görev gereksinimlerini karşılamak için aynı arayüzde farklı modeller arasında esnek bir şekilde geçiş yapın.
...
- **Üç katmanlı Beceriler** — Yerleşik beceriler (POUNDING ile birlikte gelen), özel beceriler (kendinizinkiler) ve Extension becerileri (üçüncü taraf uzantılar tarafından katkıda bulunulan); beceri göstergesi ile konuşma başına etkinleştirin/devre dışı bırakın
...
POUNDING önceden tanımlanmış yeteneklere sahip **21 profesyonel asistan** içerir, özel beceriler aracılığıyla genişletilebilir:
...
_7/24 AI asistanınız — POUNDING'ye herhangi bir cihazdan, her yerden erişin._
...
> **Kurulum:** POUNDING Ayarları → WebUI Ayarları → Kanal, Bot Token'ı yapılandırın.
...
> [Uzaktan İnternet Erişimi Öğreticisi](https://github.com/halojerry/POUNDING/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Uyanık kal** — POUNDING görevler aktifken sistem uyku moduna geçmeyi otomatik olarak önler ve uyandıktan sonra kaçırılan tetikleyicileri algılar
...
> [Görüntü oluşturma modeli yapılandırma kılavuzu](https://github.com/halojerry/POUNDING/wiki/POUNDING-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Neden POUNDING, Claude Cowork Yerine?
...
POUNDING **ücretsiz ve açık kaynaklı bir Çoklu AI Agent Masaüstü** uygulamasıdır. Sadece macOS'ta çalışan ve Claude'ye kilitli Claude Cowork ile karşılaştırıldığında, POUNDING tam model, çapraz platform geliştirilmiş versiyonudur.

| Boyut           | Claude Cowork | POUNDING                                            |
| :-------------- | :------------ | :------------------------------------------------ |
...
C: <strong>Hayır.</strong> POUNDING kurulumdan hemen sonra çalışan yerleşik bir AI Agent'a sahiptir. Başlamak için herhangi bir API anahtarı girmeniz yeterli. Ayrıca Claude Code veya Gemini CLI gibi CLI araçlarınız da kuruluysa, POUNDING bunları otomatik olarak algılayacak ve daha fazla yetenek için entegre edecektir.
</details>

<details>
<summary><strong>S: POUNDING ile ne yapabilirim?</strong></summary>
C: POUNDING sizin <strong>özel Cowork çalışma alanınızdır</strong>. Yerleşik Agent klasörleri toplu olarak organize edebilir, Excel verilerini işleyebilir, belgeler oluşturabilir, web'de arama yapabilir ve görüntüler oluşturabilir. Çoklu Agent Modu ile aynı arayüz üzerinden Claude Code, Codex ve diğer güçlü CLI Agent'larından da yararlanabilirsiniz.
</details>

<details>
<summary><strong>S: Ücretsiz mi?</strong></summary>
C: POUNDING tamamen ücretsiz ve açık kaynaklıdır. Yalnızca seçtiğiniz sağlayıcının API kullanımı için ödeme yaparsınız ve tercih ettiğiniz herhangi bir sağlayıcıdan API anahtarları kullanabilirsiniz.
</details>
...
## İnsanların POUNDING'yi Nasıl Kullandığını Görün
...
> **POUNDING hakkında bir video yaptınız mı?** [X'te bize bildirin](https://x.com/POUNDING) ve burada öne çıkaralım!
...
- [📖 Tam Kurulum Kılavuzu](https://github.com/halojerry/POUNDING/wiki/Getting-Started) — İndirmeden yapılandırmaya kadar detaylı adımlar
- [⚙️ LLM Yapılandırma Kılavuzu](https://github.com/halojerry/POUNDING/wiki/LLM-Configuration) — Çoklu platform AI model yapılandırması
- [🤖 Çoklu Agent Modu Kurulumu](https://github.com/halojerry/POUNDING/wiki/ACP-Setup) — Terminal AI Agent'larını entegre edin
- [🔌 MCP Araç Yapılandırması](https://github.com/halojerry/POUNDING/wiki/MCP-Configuration-Guide) — Model Context Protocol sunucu kurulumu
- [🌐 WebUI Yapılandırma Kılavuzu](https://github.com/halojerry/POUNDING/wiki/WebUI-Configuration-Guide) — Tam WebUI kurulum ve yapılandırma öğreticisi

**🎯 Kullanım Senaryoları**

- [📁 Dosya Yönetimi](https://github.com/halojerry/POUNDING/wiki/file-management) — Akıllı dosya organizasyonu
- [📊 Excel İşleme](https://github.com/halojerry/POUNDING/wiki/excel-processing) — AI destekli veri işleme
- [🎨 Görüntü Oluşturma](https://github.com/halojerry/POUNDING/wiki/POUNDING-Image-Generation-Tool-Model-Configuration-Guide) — AI görüntü oluşturma
- [📚 Daha Fazla Kullanım Senaryosu](https://github.com/halojerry/POUNDING/wiki/Use-Cases-Overview)

**❓ Destek ve Yardım**

- [❓ SSS](https://github.com/halojerry/POUNDING/wiki/FAQ) — Sorular ve sorun giderme
- [🔧 Yapılandırma ve Kullanım Öğreticileri](https://github.com/halojerry/POUNDING/wiki/Configuration-Guides) — Tam yapılandırma dokümantasyonu
...
POUNDING yerel geliştirme iki depo kullanır: Electron frontend için POUNDING ve yerel backend için AionCore. macOS, Linux ve Windows için tam kurulum adımları için [Development Guide](../contributing/development.md) belgesine bakın.
