...
function getFontDir() {
  const candidates = [
    ...
    path.join(process.env.HOME || '', 'Library/Application Support/POUNDING/config/skills/canvas-design/canvas-fonts'),
    path.join(process.env.APPDATA || '', 'POUNDING/config/skills/canvas-design/canvas-fonts'),
  ].filter(Boolean);
