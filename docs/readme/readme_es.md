...
[🤔 ¿Por qué elegir POUNDING?](#-por-qué-elegir-aionui-sobre-claude-cowork) ·
...
**POUNDING es más que un cliente de chat.** Es una plataforma Cowork donde los AI Agents trabajan contigo en tu computadora — leyendo archivos, escribiendo código, navegando por la web y automatizando tareas. Puedes ver todo lo que hace el Agent y siempre tienes el control.

|                                             | Clientes de chat AI tradicionales | **POUNDING (Cowork)**                                                                                                                |
| :------------------------------------------ | :-------------------------------- | :--------------------------------------------------------------------------------------------------------------------------------- |
...
POUNDING viene con un motor de Agent AI completo. A diferencia de las herramientas que requieren instalar CLI Agents por separado, **POUNDING funciona en el momento en que lo instalas**.
...
Si ya usas Claude Code, Codex, Hermes Agent u OpenClaw, POUNDING los detecta automáticamente y te permite hacer Cowork con todos ellos — junto con el Agent integrado.

**Agents compatibles:** Agent integrado (configuración cero) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Aion CLI (aionrs, el servicio backend en Rust distribuido con POUNDING) • Snow CLI • Hermes Agent • Cursor Agent y más
...
- **Ejecución paralela multi-agent** — Leader divide las tareas en subtareas y las delega a agentes Teammate que se ejecutan en paralelo; cada Teammate usa su propio modelo a través de ACP (Agent Communication Protocol, la capa de coordinación multi-agent de POUNDING), Gemini o Aionrs
...
Otras apps de AI te dan una caja de chat con tu clave API. **POUNDING te da un Cowork Agent completo.**
...
Las mismas capacidades del Agent — lectura/escritura de archivos, búsqueda web, generación de imágenes, uso de herramientas — independientemente del modelo que lo impulse. POUNDING admite **30+ plataformas AI** incluyendo servicios en la nube y despliegues locales.
...
POUNDING también admite el servicio de puerta de enlace [NewAPI](https://github.com/QuantumNous/new-api) — un centro unificado de modelos AI que agrega y distribuye varios LLMs. Cambia flexiblemente entre diferentes modelos en la misma interfaz para satisfacer diversos requisitos de tareas.
...
- **Habilidades de tres niveles** — Habilidades integradas (incluidas con POUNDING), habilidades personalizadas (las tuyas) y habilidades de Extension (aportadas por extensiones de terceros); habilita/deshabilita por conversación con el indicador de habilidades
...
POUNDING incluye **21 asistentes profesionales** con capacidades predefinidas, extensibles a través de habilidades personalizadas:
...
**Habilidades personalizadas**: Crea habilidades en el directorio `skills/`, habilita/deshabilita habilidades para asistentes para extender las capacidades AI. Las habilidades provienen de tres fuentes: integradas (incluidas con POUNDING), personalizadas (las tuyas) y Extension (aportadas a través del SDK de Extension). Las habilidades integradas incluyen `pptx`, `docx`, `pdf`, `xlsx`, `mermaid` y más.
...
_Tu asistente AI 24/7 — accede a POUNDING desde cualquier dispositivo, en cualquier lugar._
...
> **Configuración:** POUNDING Settings → WebUI Settings → Channel, configura el Bot Token.
...
> [Tutorial de acceso remoto a Internet](https://github.com/halojerry/POUNDING/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Evitar suspensión** — POUNDING previene automáticamente la suspensión del sistema mientras las tareas están activas y detecta activaciones perdidas tras el despertar
...
> [Guía de configuración del modelo de generación de imágenes](https://github.com/halojerry/POUNDING/wiki/POUNDING-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 ¿Por qué elegir POUNDING sobre Claude Cowork?
...
POUNDING es un **Escritorio Multi-AI Agent gratuito y de código abierto**. En comparación con Claude Cowork que solo se ejecuta en macOS y está bloqueado a Claude, POUNDING es su versión mejorada de modelo completo y multiplataforma.

| Dimensión          | Claude Cowork     | POUNDING                                                 |
| :----------------- | :---------------- | :----------------------------------------------------- |
...
R: <strong>No.</strong> POUNDING tiene un AI Agent integrado que funciona inmediatamente después de la instalación. Solo ingresa cualquier clave API para empezar. Si también tienes herramientas CLI como Claude Code o Gemini CLI instaladas, POUNDING las detectará e integrará automáticamente para aún más capacidades.
</details>

<details>
<summary><strong>P: ¿Qué puedo hacer con POUNDING?</strong></summary>
...
R: POUNDING es completamente gratuito y de código abierto. Solo pagas por el uso de la API del proveedor que elijas, y puedes usar claves API de cualquier proveedor que prefieras.
</details>
...
## Ver cómo la gente usa POUNDING
...
> **¿Hiciste un video sobre POUNDING?** [Avísanos en X](https://x.com/POUNDING) y lo destacaremos aquí!
...
- [📖 Guía de instalación completa](https://github.com/halojerry/POUNDING/wiki/Getting-Started) — Pasos detallados desde la descarga hasta la configuración
- [⚙️ Guía de configuración LLM](https://github.com/halojerry/POUNDING/wiki/LLM-Configuration) — Configuración de modelos AI multiplataforma
- [🤖 Configuración del modo Multi-Agent](https://github.com/halojerry/POUNDING/wiki/ACP-Setup) — Integrar Agents AI de terminal
- [🔌 Configuración de herramientas MCP](https://github.com/halojerry/POUNDING/wiki/MCP-Configuration-Guide) — Configuración del servidor Model Context Protocol
- [🌐 Guía de configuración WebUI](https://github.com/halojerry/POUNDING/wiki/WebUI-Configuration-Guide) — Tutorial completo de configuración y configuración de WebUI

**🎯 Casos de uso**

- [📁 Gestión de archivos](https://github.com/halojerry/POUNDING/wiki/file-management) — Organización inteligente de archivos
- [📊 Procesamiento de Excel](https://github.com/halojerry/POUNDING/wiki/excel-processing) — Procesamiento de datos impulsado por AI
- [🎨 Generación de imágenes](https://github.com/halojerry/POUNDING/wiki/POUNDING-Image-Generation-Tool-Model-Configuration-Guide) — Creación de imágenes AI
- [📚 Más casos de uso](https://github.com/halojerry/POUNDING/wiki/Use-Cases-Overview)

**❓ Soporte y ayuda**

- [❓ FAQ](https://github.com/halojerry/POUNDING/wiki/FAQ) — Preguntas y solución de problemas
- [🔧 Tutoriales de configuración y uso](https://github.com/halojerry/POUNDING/wiki/Configuration-Guides) — Documentación de configuración completa
...
El desarrollo local de POUNDING usa dos repositorios: POUNDING para el frontend de Electron y AionCore para el backend local. Consulta la [guía de desarrollo](../contributing/development.md) para la configuración completa en macOS, Linux y Windows.
